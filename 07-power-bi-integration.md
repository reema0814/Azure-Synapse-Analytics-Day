...
10. When prompted, set the query type to **Direct Query** and select **OK**.
    ...
    >**Note**: If you have trouble connecting to the data source, open file explorer and right-click on the downloaded .pbids file and select **Open with Power BI Desktop**.
